...
export function buildElementView(element, ctx) {
    ...
    // swipeActions (List rows): wraps the node in a swipe-to-reveal container - the edge
    // action panels behind an opaque, translating content layer. A no-op unless a
