...
//
// Property: color (String) - a named color ("red", "primary"/"secondary"), a hex string
// ("#RRGGBB" / "#RRGGBBAA"), or "<color>.opacity(<fraction>)". Resolved through the shared
// resolveColor (which warns on an unknown color); a missing/unresolvable color renders transparent.
