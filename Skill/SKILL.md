...
When a property isn't working as expected, when you need the complete property list for an element, or when your SwiftUI knowledge of a modifier may be incomplete or outdated, read the relevant `docs/Schemas/<Type>.md` file. For a starting-point JSON snippet, use `docs/Elements/<Type>.json`.



*Generated by Tools/build_skill.py — edit Skill/master/content/*.md, not this file.*
