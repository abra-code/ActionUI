...
/*
 Sample JSON for VStack:
 {
   ...
   "properties": {
     "alignment": "center", // Optional: "leading", "center", "trailing"
...
struct VStack: StaticElement, ViewBuilder {
    static func validateProperties(_ properties: [String: Any]) -> [String: Any] {
        ...
        if let alignment = properties["alignment"] as? String,
           !["leading", "center", "trailing"].contains(alignment) {
            print("Warning: VStack alignment '\(alignment)' invalid; using SwiftUI default")
    ...
    static func register(in registry: ViewBuilderRegistry) {
        registry.register("VStack") { element, state, dialogGUID in
