...
/*
 Sample JSON for ScrollView:
 {
   ...
   "content": {          // Required: Single child view or array of views. Note: Declared as a top-level key in JSON but stored in subviews["content"] by StaticElement.init(from:).
