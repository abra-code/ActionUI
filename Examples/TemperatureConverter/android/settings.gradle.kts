...
rootProject.name = "TemperatureConverterAndroid"
...
// composite build. The :app module requests "com.abracode.actionui:library";
// this substitution maps that coordinate to the :library project inside
// ActionUIAndroid, which is built from source. No publishing/Maven needed.
