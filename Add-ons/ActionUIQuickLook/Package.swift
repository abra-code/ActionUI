...
//
// ActionUIQuickLook - an optional ActionUI add-on, packaged as a Swift package.
//
...
// link: false. The host links this product + ActionUI and calls ActionUIQuickLook.register().

import PackageDescription

let package = Package(
    name: "ActionUIQuickLook",
    platforms: [
        .macOS("14.6"),
        .iOS("17.6"),
        .visionOS("2.6"),
    ...
    products: [
        .library(name: "ActionUIQuickLook", targets: ["ActionUIQuickLook"]),
        ...
        .library(name: "ActionUIQuickLookDocumentation", targets: ["ActionUIQuickLookDocumentation"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            name: "ActionUIQuickLookDocumentation",
            path: "Documentation",
            sources: ["ActionUIQuickLookDocumentation.swift"],
            resources: [
                .copy("Schemas"),
                .copy("Elements"),
            ]
