// Add-ons/ActionUIDiff/Tests/DiffTests.swift
//
// Component tests of the ActionUIDiff add-on's standalone diff-viewer (module DiffView): the
// line-diff model (DiffComputer - interleaving, line numbers, context collapsing, degenerate
// cases) and DiffView's rendering-cap arithmetic. Deliberately free of Chat / ActionUI types,
// matching the component's standalone design.
